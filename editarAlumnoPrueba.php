...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    <title>Editar Alumno Prueba</title>
    <script>

function confirmar(){
var respuesta=confirm("¿Esta seguro que desea editar alumno a prueba?");
if (respuesta == false){
...
<body>
    ...
    <div class="container mt-5">
     ...
     ?>
        ...
        <h2 class="text-success text-center font-weight-bold font-italic mt-5">Editar Alumnos a Prueba</h2>    
    <!-- comienzo el formulario -->  
    <center>
    <div class="col-md-8 col-lg-6 mt-5">
        <form action="insertarEdicionAlumnoPrueba.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="inputState" class="text-success">Actividad/Entrenamiento</label>
    ...
    ?>  
          ...
          <input type="submit" name="estado" onclick="confirmar();" value="Editar" class="btn btn-success mt-3" >
