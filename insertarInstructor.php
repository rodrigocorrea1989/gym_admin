...
if ($password != $password2){
    ...
    echo "<center><h2 class='text-primary font-capitalize'>Las contraseña no coinciden</h2>, <a class='btn btn-primary text-light' href='\centrofitness\\registrarInstructor.php'> vuelva a intentarlo </a> <center>";
...
$sql="insert into instructores (dni,cuil,nombre,apellido,edad,fechaIngreso,numeroContacto,fechaNacimiento,password,privilegio) values ('$dni','$cuil','$nombre','$apellido','$edad','$fecha','$tel','$nacimiento','$password','$privilegio')";
...
if(mysqli_affected_rows($miconexion)){
    ...
    echo "<br><center><h2 class='text-primary text-capitalize font-weight-bold font-italic'>se ha insertado correctamente</h2></center>";
    echo "</div>";
