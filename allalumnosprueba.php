...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
    <title>Todos los Alumnos a Prueba</title>
    <script>

function confirmar(){
var respuesta=confirm("¿Esta seguro que desea Matricular Este Alumno a Prueba?");
if (respuesta == false){
...
<body>
    ...
    <?php include("mostrarUsuario.php");  ?>
      ...
      <?php
          ...
          $sqlCount="SELECT * FROM ALUMNOSPRUEBA WHERE INSTRUCTOR = '$nombreUsuario'";
           
          }else if($privilegio=="admin"){

            $sqlCount="SELECT * FROM ALUMNOSPRUEBA ";
      ...
      ?>
           ...
           <center> <h2 class="text-success font-weight-bold font-capitalize">Alumnos a Prueba (<?php echo $contador ?>)</h2></center>
...
?>
        ...
        <div class="row">
          ...
          $sql="SELECT * FROM ALUMNOSPRUEBA WHERE DNI LIKE '%$dni%' AND NOMBRE LIKE '%$nombre%' AND APELLIDO LIKE '%$apellido%'
          ...
          AND ACTIVIDAD LIKE '%$actividad%' "; 
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-success text-light" href="profile.php?dni=<?php  echo $registro["dni"]   ?>&tipo=prueba">VER PERFIL</a></td> 
                    <td><a class="btn btn-success text-light" href="\centrofitness\editarAlumnoPrueba.php?dni=<?php echo $dni ?> ">Editar</a></td>
                    <td><a class="btn btn-primary text-light" onclick="confirmar();" href="\centrofitness\matricularAlumnoPrueba.php?dni=<?php echo $dni ?> ">Matricular</a></td>
                    <td><a class="btn btn-danger text-light" href="\centrofitness\darBajaAlumnaPrueba.php?dni=<?php echo $dni ?> ">Dar de Baja</a></td>
