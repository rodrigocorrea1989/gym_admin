...
<head>
    ...
    <title>Insertar Edicion Alumno Activo</title>
</head>
<body>
<header>  
        <!-- barra de navegación-->
...
$sql="UPDATE ALUMNOSACTIVO SET NOMBRE='$nombre' , APELLIDO='$apellido' , EDAD='$edad', TELEFONO='$tel' , fechaNacimiento='$nacimiento', fechaInscripcion=
