...
<body>
    ...
    <!-- Formulario -->
    <h2 class="text-danger text-center font-weight-bold font-italic mt-5">Dar Baja Alumno Activo</h2>    
    <!-- comienzo el formulario -->  
    <center>
    <div class="col-md-8 col-lg-6 mt-5">
        <form action="procesarBajaAlumnoActivo.php" method="POST">
        ...
        <div class="form-group">
          <label class="text-primary" for="formGroupExampleInput">Actividad</label>
        ...
        <div class="form-group">
          <label class="text-primary" for="formGroupExampleInput">Instructor</label>
          <input  type="text" name="instructor" value="<?php echo $registro["instructor"];  ?>" class="form-control mt-3 text-danger" id="formGroupExampleInput" placeholder="Peréz" required  readonly>
        </div>
        <div class="form-group">
          <label class="text-primary" for="formGroupExampleInput">Estado</label>
        ...
        <div class="form-group">
        <label class="text-primary font-italic" for="Textarea1">ESCRIBE UNA DESCRIPCIÓN</label>
        <textarea class="form-control" id="Textarea1" name="descripcion" rows="3"></textarea>
  </div>
        
           <input type="submit" value="Dar Baja" onclick="confirmar();"  class="btn btn-danger mt-3" >
